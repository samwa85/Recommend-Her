const t=[{slug:"sponsorship-vs-mentorship",title:"The Power of Sponsorship vs. Mentorship",excerpt:"Understanding the difference and why sponsorship matters more for career advancement.",date:"Jan 15, 2026",category:"Leadership",readTime:"6 min read",featured:!0,author:{name:"Dr. Amina Hassan",title:"Executive Coach & Leadership Expert",image:"/images/author-amina.jpg"},tags:["Sponsorship","Mentorship","Career Growth","Leadership"],content:`
...
At Recommend Her, we're building a community where sponsorship isn't just encouraged—it's embedded in our DNA. Join us, and let's lift each other to new heights.
    `},{slug:"success-story-sarah",title:"Success Story: How Sarah Landed Her Dream Role",excerpt:"A Recommend Her talent shares her journey from submission to promotion.",date:"Jan 10, 2026",category:"Success Stories",readTime:"5 min read",featured:!1,author:{name:"Sarah Mitchell",title:"VP of Product at TechVentures",image:"/images/author-sarah.jpg"},tags:["Success Story","Career Change","Product Management","Testimonial"],content:`
...
[Submit Your Profile](/for-talent) | [Become a Sponsor](/for-sponsors)
    `},{slug:"inclusive-leadership-pipeline",title:"Building an Inclusive Leadership Pipeline",excerpt:"How organizations can create pathways for diverse talent to reach the top.",date:"Jan 5, 2026",category:"Diversity & Inclusion",readTime:"8 min read",featured:!1,author:{name:"Marcus Chen",title:"Chief Diversity Officer at GlobalTech",image:"/images/author-marcus.jpg"},tags:["Diversity","Inclusion","Leadership","Organizational Change"],content:`
...
*Ready to transform your leadership pipeline? [Partner with us](/contact) to connect with exceptional diverse talent ready for their next chapter.*
    `}];function r(e){return t.find(o=>o.slug===e)}function i(){return[...new Set(t.map(e=>e.category))]}export{r as a,t as b,i as g};
